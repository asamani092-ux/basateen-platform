...
CREATE TABLE student_circle_history_fix_042 (
  ...
  old_circle_id INTEGER REFERENCES circles(id) ON DELETE SET NULL,
  new_circle_id INTEGER REFERENCES circles(id) ON DELETE SET NULL,
  old_track_id INTEGER REFERENCES tracks(id) ON DELETE SET NULL,
  new_track_id INTEGER REFERENCES tracks(id) ON DELETE SET NULL,
