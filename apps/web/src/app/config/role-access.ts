...
export const ROLE_HOME: Record<UserRole, string> = {
  super_admin: "/super-admin/staff",
  edu_supervisor: "/edu-dept/dashboard",
  admin_supervisor: "/admin-dept/student-attendance",
...
const PATH_RULES: Array<{ prefix: string; roles: UserRole[] }> = [
  ...
  { prefix: "/admin-dept", roles: ["admin_supervisor"] },
...
export const LEGACY_REDIRECTS: Record<string, string | "home"> = {
  ...
  "/general-supervisor": "/admin-dept/student-attendance",
  ...
  "/general-supervisor/violations": "/admin-dept/violations",
  "/general-supervisor/dashboard": "/admin-dept/dashboard",
