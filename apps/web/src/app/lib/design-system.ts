...
export const ds = {
  ...
  table: {
    head: "text-right align-middle font-medium text-sm text-muted-foreground px-3 py-2.5",
    cell: "text-right align-middle text-sm px-3 py-2.5",
    truncateCell: "max-w-0 truncate whitespace-nowrap",
    colName: "w-[22%] max-w-[220px]",
    colId: "w-[14%] max-w-[140px]",
    colPhone: "w-[14%] max-w-[140px]",
    colPlacement: "w-[18%] max-w-[180px]",
    colStatus: "w-[10%]",
    colStatusCompact: "w-[1%] whitespace-nowrap",
    headActions: "text-center align-middle w-[1%] whitespace-nowrap px-2 py-2.5",
    headActionsWide: "text-center align-middle w-[1%] whitespace-nowrap px-2 py-2.5",
    actionsCell: "text-center align-middle w-[1%] whitespace-nowrap p-2",
    actionsCellWide: "text-center align-middle w-[1%] whitespace-nowrap p-2",
    actionsWrap: "flex items-center justify-center gap-0.5",
    actionsWrapWide: "flex flex-wrap items-center justify-center gap-0.5",
  },
  nav: {
    active:
